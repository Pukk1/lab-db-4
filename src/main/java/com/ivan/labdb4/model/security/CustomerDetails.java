...
public class CustomerDetails implements UserDetails {
    ...
    public CustomerDetails(String username, String password, List<SimpleGrantedAuthority> authorities, boolean isActive) {
    ...
    public static UserDetails fromUser(Customer customer) {
        ...
        return new org.springframework.security.core.userdetails.User(
                ...
                customer.getStatus().equals(CustomerStatus.ACTIVE),
                customer.getStatus().equals(CustomerStatus.ACTIVE),
                customer.getStatus().equals(CustomerStatus.ACTIVE),
                customer.getStatus().equals(CustomerStatus.ACTIVE),
